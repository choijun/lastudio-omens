...
class LaStudioKit_Price_List extends LaStudioKit_Base {
	...
	protected function enqueue_addon_resources(){
		wp_register_style( $this->get_name(), lastudio_kit()->plugin_url('assets/css/addons/price-list.css'), [], lastudio_kit()->get_version());
    ...
    protected function register_controls() {
        $css_scheme = apply_filters(
            'lastudio-kit/price-list/css-scheme',
            array(
                'price_list'       => '.lakit-price-list',
                'item'             => '.lakit-price-list .price-list__item',
                'item_inner'       => '.lakit-price-list .price-list__item-inner',
                'item_title'       => '.lakit-price-list .price-list__item-title',
                'item_price'       => '.lakit-price-list .price-list__item-price',
                'item_description' => '.lakit-price-list .price-list__item-desc',
                'item_separator'   => '.lakit-price-list .price-list__item-separator',
                'item_image_wrap'  => '.lakit-price-list .price-list__item-img-wrap',
            )
        );
	    ...
	    $this->add_responsive_control(
		    'title_min_width',
		    array(
			    'label'      => esc_html__( 'Title Minimal Width (px)', 'lastudio-kit' ),
			    'type'       => Controls_Manager::SLIDER,
			    'size_units' => array(
				    'px',
			    ),
        ...
        $this->add_responsive_control(
            'price_min_width',
            array(
                'label'      => esc_html__( 'Price Minimal Width (px)', 'lastudio-kit' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
