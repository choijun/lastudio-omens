<?php
/*
Plugin Name:    Omens Package Demo Data
...
class Omens_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'omens';

    public static $demo_site = 'https://omens.la-studioweb.com/';
...
add_action('plugins_loaded', function(){
    ...
    if(strpos(strtolower($theme->get_template()), 'omens') === false){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Omens Package Demo Data" requires %3$s"Omens"%4$s theme to be installed and activated. Please active %3$s"Omens"%4$s to continue.%2$s', 'lastudio-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Omens_Data_Demo_Plugin_Class::get_instance();
}, 999);